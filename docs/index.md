...
| [Architecture](docs/architecture.md) | Structural and behavioral map of the Flatseek codebase |
...
| [Slice](docs/build.md) | Materialize query results as a new standalone index |
| [Serving](docs/serving.md) | Self-hosted API server with embedded dashboard |
| [Storage](docs/storage.md) | HuggingFace, S3, Vercel Blob backends |
